...
contract Ownable {
    ...
    modifier isAddress(address currentAddress) {
        require(currentAddress != address(0), "Address is not a valid address");
        _;
    }
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(ownerOf(tokenId) != to, "Current token owner cannot be approved");
    ...
    // TIP: remember the functions to use for Counters. you can refresh yourself with the link above
    function _mint(address to, uint256 tokenId) internal isAddress(to) {
    ...
    // TIP: remember the functions to use for Counters. you can refresh yourself with the link above
    function _transferFrom(address from, address to, uint256 tokenId) internal isAddress(to) {

        // TODO: require from address is the owner of the given token
        require(ownerOf(tokenId) == from, "From address must be the token owner");
